...
const About = () => {
  return (
    <section className="mt-20" id="about">
      ...
      <div className="mt-8">
        <h4 className="font-medium text-lg">Highlights</h4>

        <ul className="mt-4 list-disc pl-10 flex flex-col gap-2">
          <li className="font-light max-w-3xl leading-8">
            <strong className="font-bold">Professional Experience:</strong>{" "}
            Developed and maintained several high-traffic web applications,
            improving user engagement by 30%.
          </li>
          <li className="font-light max-w-3xl leading-8">
            <strong className="font-bold">Projects:</strong> Created an
            AI-driven news content creator and a social engagement platform,
            both showcasing unique personalized user experiences.
          </li>
          <li className="font-light max-w-3xl leading-8">
            <strong className="font-bold">Achievements:</strong> Recognized as
            Employee of the Year at Panxora.io, and consistently received top
            performance reviews.
          </li>
          <li className="font-light max-w-3xl leading-8">
            <strong className="font-bold">Technical Skills:</strong> Proficient
            in JavaScript, TypeScript, React, Next.js, Node.js, Express,
            MongoDB, and more.
          </li>
          <li className="font-light max-w-3xl leading-8">
            <strong className="font-bold">Personal Interests:</strong> Beyond
